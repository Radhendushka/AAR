...
lower_limit_fit_b3_adjusted=Bootstrap3$predicted_Adjusted_AAR_quantile_025_star
lower_limit_fit_b_adjusted=c(lower_limit_fit_b1_adjusted,lower_limit_fit_b2_adjusted,lower_limit_fit_b3_adjusted)*g[1]
...
upper_limit_fit_b3_adjusted=Bootstrap3$predicted_Adjusted_AAR_quantile_975_star
upper_limit_fit_b_adjusted=c(upper_limit_fit_b1_adjusted,upper_limit_fit_b2_adjusted,upper_limit_fit_b3_adjusted)*g[1]
...
fit_y3=log(1+S_Estimates3$tilde_gamma*x3)+S_Estimates3$tilde_log_g
fit_y=c(fit_y1,fit_y2,fit_y3)
...
lower_limit_fit_y3=Bootstrap3$predicted_log_AAR_quantile_025_star
lower_limit_fit_y=c(lower_limit_fit_y1,lower_limit_fit_y2,lower_limit_fit_y3)
...
upper_limit_fit_y3=Bootstrap3$predicted_log_AAR_quantile_975_star
upper_limit_fit_y=c(upper_limit_fit_y1,upper_limit_fit_y2,upper_limit_fit_y3)
...
mean(b_adjusted[ind3]>lower_limit_fit_b_adjusted[ind3] & b_adjusted[ind3]<upper_limit_fit_b_adjusted[ind3])
...
text(25,75,"ϱ=0.885",cex=1.2)
text(325,75,"ϱ=0.974",cex=1.2)
text(725,75,"ϱ=0.754",cex=1.2)
...
mtext("Fitted Adjusted AAR (meter/kyr)", side = 1, line = 3,cex=1.5)
mtext(" Adjusted AAR (meter/kyr)", side = 2, line = 3,cex=1.5)

text(10,70,"γ=0.056",cex=1.5)
text(10,65,"ϱ=0.885",cex=1.5)
...
lines(10:50,10:50)
text(10,70,"γ=0.060",cex=1.5)
text(10,65,"ϱ=0.974",cex=1.5)


mtext("Fitted Adjusted AAR (meter/kyr)", side = 1, line = 3,cex=1.5)
plot( fit_b_adjusted[ind3],b_adjusted[ind3],lwd=2, 
      ylab = "",
      main = " ", 
      xlab = "",
      col = "#00BFFF",
...
lines(10:50,10:50)
mtext("Fitted Adjusted AAR (meter/kyr)", side = 1, line = 3,cex=1.5)
text(10,70,"γ=0.073",cex=1.5)
text(10,65,"ϱ=0.754",cex=1.5)
